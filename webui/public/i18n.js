...
const I18N = {
  zh: {
    ...
    "home.sensitiveVisibility.title": "敏感操作 / 截屏审计（SSH 密钥/凭据文件/环境变量查找/历史指令读取、Bash 截图命令/打开图片/MCP 截图动作，按命中的规则/命令与工具名近似识别，非精确，点开看分类明细）",
  ...
  en: {
    ...
    "home.sensitiveVisibility.title": "Sensitive Operations / Screenshot Audit (SSH keys/credential files/env-var lookups/history reads, Bash screenshot commands/opened images/MCP screenshot actions — approximated from the matched rule or command/tool name, not exact; click for the category breakdown)",
