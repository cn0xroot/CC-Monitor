...
const I18N = {
  zh: {
    ...
    "home.screenshotOps.title": "截屏审计（Bash 截图命令 / 打开图片 / MCP 截图动作，按命令与工具名近似识别，非精确）",
  ...
  en: {
    ...
    "home.screenshotOps.title": "Screenshot Audit (Bash screenshot commands / opened images / MCP screenshot actions, approximated from command and tool name, not exact)",
