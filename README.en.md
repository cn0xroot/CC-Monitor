...
Binds to `127.0.0.1` only: this tool can spawn terminal processes directly and has no authentication, so it must never be exposed to a public network or LAN.
